...
Parameter2reg   par3  ( 5,                // _id        - Идентификатор параметра. Для привязки к FRAM
                      "B.1.0",                 // _menu      - Идентификатор меню.
...
DecoratorCalibrated calibratedParameter ( mapsOfParameters,  new Parameter2reg( 6,                // _id        - Идентификатор параметра. Для привязки к FRAM
                      "B.1.1",                 // _menu      - Идентификатор меню.
